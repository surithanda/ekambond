...
import { Search, Zap, Globe, CheckCircle } from "lucide-react";
import { globalSearch, globalSearchStats } from "@/data/features/features-data";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
              ...
              <div className="relative space-y-8 pt-8 z-10">
                ...
                <div className="text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted text-sm font-neue-haas-regular">
                      Powerful AI-enforced filtering
                    </p>
                  </div>
                </div>

                {/* Search Stats */}
                <div className="bg-orange rounded-2xl p-6 text-center text-white">
                  <div className="text-4xl font-neue-haas-medium mb-2"></div>
                  <div className="text-orange-100 text-sm font-neue-haas-regular">
                    Daily Searches Worldwide
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {globalSearchStats.map((stat, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-3 bg-orange-50 rounded-xl border border-orange-100"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-lg bg-orange text-primary flex items-center justify-center">
                            <Zap className="w-4 h-4" />
                          </div>
                          <div>
                            <div className="text-sm font-neue-haas-medium text-gray-700">
                              {stat.label}
                            </div>
                            <div className="text-xs font-neue-haas-regular text-gray-500">
                              {stat.description}
                            </div>
                          </div>
                        </div>
                        <div className="text-lg font-neue-haas-medium text-orange">
                          {stat.value}
                        </div>
                      </div>
                    ))}
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-br from-orange-400 to-orange-500 rounded-full opacity-20 shadow-lg"
            ></motion.div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-xl font-neue-haas-regular text-muted mt-6 leading-relaxed max-w-2xl">
                  ...
                  Discover compatible matches across regions, cultures, and
                  communities with real-time AI filters.
                </p>
              </motion.div>
            </div>
