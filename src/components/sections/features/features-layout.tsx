...
import { Users, CheckCircle, Shield, Zap } from "lucide-react";
import { featuresLayoutData } from "@/data/features/features-data";

const ProfileManagementHero = () => {
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              >
                <h1 className="text-5xl lg:text-6xl font-neue-haas-medium text-gray-900 leading-tight">
                  Profile
                  <span className="block bg-clip-text text-orange">
                    Management
                  </span>
                </h1>
                ...
                <p className="text-xl text-muted mt-6 leading-relaxed max-w-2xl font-neue-haas-regular">
                  ...
                  A comprehensive system that supports detailed and dynamic
                  profile creation with enterprise-grade security.
                </p>
              </motion.div>
            </div>
            ...
            >
              {featuresLayoutData.map((feature, index) => {
                          ...
                          {isActive && (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2 mt-3">
                                ...
                                <span className="text-sm font-neue-haas-regular text-orange">
                                  {feature.stat}
                                </span>
                              </div>
                            </motion.div>
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 shadow-2xl border border-gray-100/50 backdrop-blur-sm">
              ...
              <div className="relative space-y-8 pt-8 z-10">
                ...
                <div className="text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted text-sm font-neue-haas-regular">
                      Advanced profile system with real-time updates
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/50 rounded-xl p-4 border border-gray-100 flex items-center justify-center text-center">
  {/* <div className="text-2xl font-neue-haas-medium text-gray-900">
    50M+
  </div> */}
  
  <div className="text-md text-muted font-neue-haas-regular font-bold">
    Profiles
  </div>
</div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-700 font-neue-haas-regular">
                      Most consistency accuracy
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl opacity-20 shadow-lg"
            ></motion.div>
            <motion.div
              animate={{
                y: [0, 10, 0],
              ...
              className="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full opacity-20 shadow-lg"
            ></motion.div>
...
export default ProfileManagementHero;
